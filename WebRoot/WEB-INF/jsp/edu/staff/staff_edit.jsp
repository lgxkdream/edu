...
<script type="text/javascript">
	...
	//保存
	function save(){
		if($("#loginname").val()=="" || $("#loginname").val()=="此登录用户名已存在!"){
...
<body>
	<form action="staff/${msg }.do" name="Form" id="Form" method="post">
		...
		<table>
			<tr>
				<td>
					<input type="text" name="USERNAME" id="loginname" value="${sysUserPd.USERNAME }" maxlength="32" placeholder="这里输入登录名" title="登录名"/>
			...
			<tr>
				<td>
					<input type="text" name="PHONE" id="PHONE" value="${pd.PHONE}" maxlength="32" placeholder="这里输入电话号码" title="电话号码"/>
					&nbsp;<span style="color:#ff0000">*</span>
				</td>
			</tr>
			<tr>
