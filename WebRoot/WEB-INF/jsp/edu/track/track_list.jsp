						...
						<c:forEach items="${varList}" var="var" varStatus="vs">
							<tr>
								...
								<td class='center' style="width: 30px;">${vs.index+1}</td>
										...
										<td>
											${var.REMARK}
											<c:if test='${var.IMG_PATH!=""}'>
											<br/>
											<c:set value="${ fn:split(var.IMG_PATH, ',') }" var="imgPathArray" />
											<c:forEach items="${ imgPathArray }" var="imgPath">
												<a href="${ imgPath }" target="_blank"><img src='${ imgPath }' width="50px" height="50px"/></a> 
											</c:forEach>
											</c:if>
										</td>
<%--										<td>${var.CREATOR}</td>--%>
