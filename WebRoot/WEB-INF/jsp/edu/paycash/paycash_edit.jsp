...
<body>
	<form action="paycash/${msg }.do" name="Form" id="Form" method="post">
		...
		<table>
			<tr>
				<td>
					<input type="text" name="STD_NAME" value="${pd.NAME}" placeholder="学生姓名" title="学生姓名" readonly="readonly">
				</td>
			</tr>
			<tr>
				<td>
			...
			<tr>
				<td style="text-align: center;">
					...
					<input name="SEND" type="checkbox" value="1" checked="checked"/><span class="lbl">发邮件</span>
