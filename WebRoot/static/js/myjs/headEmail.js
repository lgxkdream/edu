...
function sendEmail_(){
	...
	$.ajax({
		type: "POST",
		url: locat+'/head/sendEmail1.do?tm='+new Date().getTime(),
    	data: {STUNAMES:STUNAMES,EMAIL:EMAIL,TYPE:TYPE,TITLE:TITLE,CONTENT:CONTENT,isAll:isAll,fmsg:fmsg},
		dataType:'json',
		//beforeSend: validateData,
		cache: false,
		success: function(data){
