...
//	   }
    ...
    public static void main(String[] args){   
        //这个类主要是设置邮件   
	     ...
	     mailInfo.setMailServerPort("25");    
	     mailInfo.setValidate(true);    
	     mailInfo.setUserName("edu@51jsoft.com");    
	     mailInfo.setPassword("Ccjsoft123456");//您的邮箱密码    
	     mailInfo.setFromAddress("edu@51jsoft.com");    
	     mailInfo.setToAddress("65242847@qq.com");    
