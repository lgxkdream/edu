...
public class InitService extends BaseService{
	...
	public void init(){
		...
		try {
			...
			Dic.dic_emailmodel_list = (List<Map>)dao.findForList("EmailMapper.listAll", null);
			Dic.dic_homework_type_list=(List<Map>)dao.findForList("dic_homework_type.select_info", null);
			
			Dic.dic_campus_list=(List<Map>)dao.findForList("dic_campus.select_info", null);
			Dic.dic_classroom_list=(List<Map>)dao.findForList("dic_classroom.select_info", null);
			Dic.dic_lesson_time_list=(List<Map>)dao.findForList("dic_time.select_info", null);
			Dic.dic_class_list=(List<Map>)dao.findForList("ClassCtrMapper.listAll", null);
